...
### The scripts below take in DESeq output comparisons (merged with bind\_rows) with an additional column saying which comparison. A simple pipeline to do this is below. See DESeq documentation for details
